...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            ...
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header">Dashboard <small> LCS Lot Control System </small></h1>
            <!-- end page-header -->
            <!-- begin row -->
        ...
        <!-- end row -->
        <div class="modal fade" id="filterloader" tabindex="-1" role="dialog" aria-labelledby="loadMeLabel" style="color:#000; margin-top: 50px">
        ...
        <!-- <script src="../Public/js/jsDashboard.js"></script> -->
